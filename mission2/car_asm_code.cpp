...
public:
    ...
    int AddCarType(int num, std::string str) {
    ...
    int AddEngineType(int num, std::string str) {
        umap_engine_type[num] = str;
        return GetEngineMaxNum();
    }
    int GetEngineMaxNum() {
    ...
    int AddBrakeType(int num, std::string str) {
        umap_brake_type[num] = str;
        return GetBrakeMaxNum();
    }
    int GetBrakeMaxNum() {
    ...
    int AddSteeringType(int num, std::string str) {
        umap_steering_type[num] = str;
        return GetSteeringMaxNum();
    }
    ...
    bool isValidCheckByCompany(int* fail_type)
    {
